...
<body class="bg-gray-50">
            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <div class="relative bg-gradient-to-br from-blue-600 to-indigo-900 px-8 pt-12 pb-20">
                    <div class="relative z-10">
                        ...
                        <p class="text-blue-100 text-center mt-2">Sign in to continue to Hanifspace</p>
                    </div>
                    <!-- Decorative Pattern -->
    ...
    <div class="bg-white rounded-xl shadow-lg p-8">
        ...
        <form method="POST" action="{{ route('session.login.post') }}">
    @csrf
    <!-- Email Input -->
    <div class="mb-6">
